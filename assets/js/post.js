  ...
  [6],
  {
            ...
            o() &&
              ...
              setTimeout(function () {
                var t = e(".medium-zoom-image--opened"),
                  ...
                  s = "scale(1) translate3d(0, ".concat(
                    i < 0 ? o * i + i : o * i - i,
                    "px, 0)"
                  );
                t.addClass("medium-zoom-image-mobile"),
                  (t[0].style.transform = s);
              }, 10);
          }),
            n.on("close", function () {
              o() &&
    ...
    19: function (e, t, n) {
      ...
      var a = n(0),
        ...
        w = !1;
      function b() {
        (f = window.pageYOffset), j();
      }
      function y(e) {
        Object(d.isMobile)("1023px")
          ? (o()("body").addClass("share-menu-displayed"),
            setTimeout(function () {
              u.removeAttr("data-aos");
            }, e))
      ...
      function k() {
        ...
        t <= 100 &&
          (function (e) {
            if (e <= 100) {
              var t = p - (e / 100) * p;
              m[0].style.strokeDashoffset = t;
            }
          })(t),
          (w = !1);
      }
      function O() {
        (h = window.innerHeight), (g = o()(document).height());
      }
      function T() {
        var e = m.parent().width(),
          t = e / 2,
          n = Object(d.isMobile)() ? 2 : 3;
        m.parent().attr("viewBox", "0 0 ".concat(e, " ").concat(e)),
          m.attr("stroke-width", n),
          m.attr("r", t - (n - 1)),
          m.attr("cx", t),
          m.attr("cy", t),
          (p = 2 * t * Math.PI),
          (m[0].style.strokeDasharray = "".concat(p, " ").concat(p)),
          (m[0].style.strokeDashoffset = p);
      }
      o()(document).ready(function () {
        u = o()(".js-aos-wrapper");
        var e = o()(".js-scrolltop"),
          t = o()(".js-load-comments"),
          n = o()(".js-comments-iframe"),
          a = o()(".js-recommended-slider");
        if (
          (s()(".js-post-content"),
          Object(d.adjustImageGallery)(),
          y(1e3),
          a.length > 0)
        ) {
          var i = new l.d(".js-recommended-slider", {
            type: "slider",
            rewind: !1,
            perView: 3,
            swipeThreshold: !1,
            dragThreshold: !1,
            gap: 0,
            direction: Object(d.isRTL)() ? "rtl" : "ltr",
            breakpoints: {
              1023: {
                type: "carousel",
                perView: 2,
          ...
          i.on("mount.after", function () {
            ...
            i.on("length.change", function (e) {
              1 === e &&
                (i.update({ type: "slider" }), a.find(".js-controls").remove());
            }),
            i.mount({
              Controls: l.b,
              Swipe: l.c,
              ...
              Length: function (e, t, n) {
                return {
                  mount: function () {
                    n.emit("length.change", t.Sizes.length);
                  },
                };
              },
            });
        ...
        Object(c.a)(".js-article-card-title", 100),
          ...
          t.click(function () {
            t.parent().hide(), n.fadeIn("slow");
          }),
          Object(d.managePostImages)(o.a),
          Object(d.makeImagesZoomable)(o.a, r.a),
