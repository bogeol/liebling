  ...
  [2],
  {
      ...
      var a = function () {
        ...
        c = function () {
          for (
            ...
            var a = e[t].closest(".kg-gallery-image"),
              o = e[t].attributes.width.value / e[t].attributes.height.value;
        ...
        d = function (e, t) {
          ...
          n.on("open", function (t) {
            o() &&
              e(t.target).parent().hasClass("kg-gallery-image") &&
              setTimeout(function () {
                var t = e(".medium-zoom-image--opened"),
                  ...
                  r = "scale(1) translate3d(0, ".concat(
                    i < 0 ? o * i + i : o * i - i,
                    "px, 0)"
                  );
                t.addClass("medium-zoom-image-mobile"),
                  (t[0].style.transform = r);
              }, 10);
          }),
            n.on("close", function () {
              o() &&
                e(event.target).parent().hasClass("kg-gallery-image") &&
                e(".medium-zoom-image").removeClass("medium-zoom-image-mobile");
            });
        };
    },
    13: function (e, t, n) {
    ...
    14: function (e, t, n) {
      ...
      o()(document).ready(function () {
        Object(h.isRTL)() && o()("html").attr("dir", "rtl").addClass("rtl");
        var e = o()("body"),
          t = o()(".js-header"),
          n = o()(".js-open-menu"),
          a = o()(".js-close-menu"),
          s = o()(".js-menu"),
          d = o()(".js-toggle-submenu"),
          f = o()(".js-submenu-option")[0],
          g = o()(".js-submenu"),
          p = o()(".js-recent-slider"),
          b = o()(".js-open-secondary-menu"),
          v = o()(".js-open-search"),
          w = o()(".js-close-search"),
          k = o()(".js-search"),
          j = o()(".js-input-search"),
          y = o()(".js-search-results"),
          C = o()(".js-no-results"),
          O = o()(".js-toggle-darkmode"),
          x = o()(".js-notification-close"),
        ...
        var L,
          ...
          R,
          V = function (e) {
            var t = o()('.js-alert[data-notification="'.concat(e, '"]'));
            t.addClass("opened"),
              setTimeout(function () {
                F(t);
              }, 5e3);
        ...
        (n.click(function () {
          t.addClass("mobile-menu-opened"), s.addClass("opened"), A();
        }),
        a.click(function () {
          t.removeClass("mobile-menu-opened"), s.removeClass("opened"), A();
        }),
        d.click(function () {
          (M = !M)
        ...
        w.click(function () {
          j.blur(), k.removeClass("opened"), A();
        }),
        j.keyup(function () {
          if (j.val().length > 0 && S) {
            var e = S.search(j.val()).filter(function (e) {
            ...
            if (e.length > 0) {
              ...
              C.hide(), y.html(t), y.show();
            } else y.html(""), y.hide(), C.show();
          } else y.html(""), y.hide(), C.hide();
        }),
        O.change(function () {
          O.is(":checked")
        ...
        o()(window).click(function (e) {
          M && f && !f.contains(e.target) && ((M = !1), I());
        }),
        o()(document).keyup(function (e) {
          "Escape" === e.key && k.hasClass("opened") && w.click();
        }),
        T
          ? (o()("html").attr("data-theme", T),
            "dark" === T && O.attr("checked", !0))
          : Object(h.isDarkMode)() && O.attr("checked", !0),
        t.length > 0) &&
          new i.a(t[0], {
            tolerance: { down: 10, up: 20 },
            offset: 15,
            onUnpin: function () {
              if (!Object(h.isMobile)() && _) {
                var e = _[0];
        ...
        if (p.length > 0) {
          var H = new r.d(".js-recent-slider", {
            type: "slider",
            rewind: !1,
            perView: 4,
            swipeThreshold: !1,
            ...
            breakpoints: {
              1024: { perView: 3, swipeThreshold: 80, dragThreshold: 120 },
              768: {
                perView: 2,
                swipeThreshold: 80,
                dragThreshold: 120,
          ...
          H.on("mount.after", function () {
            Object(l.a)(".js-recent-article-title", 50);
          }),
            H.mount({ Swipe: r.c, Breakpoints: r.a });
        }
        if (
          ("undefined" != typeof disableFadeAnimation && disableFadeAnimation
            ? o()("[data-aos]").addClass("no-aos-animation")
            : u.a.init({ once: !0, startEvent: "DOMContentLoaded" }),
          b.length > 0)
        ) {
          var N = document.getElementById("secondary-navigation-template");
          _ = Object(c.a)(".js-open-secondary-menu", {
            content: N.innerHTML,
            arrow: !0,
            trigger: "click",
            interactive: !0,
        ...
        Object(c.a)(".js-tooltip"),
          ...
          (L = Object(h.getParameterByName)("action")),
          (D = Object(h.getParameterByName)("stripe")),
          "subscribe" === L && V("subscribe"),
          "signup" === L &&
          ...
          "checkout" === L && V("signup"),
          "signin" === L && V("signin"),
          "success" === D && V("checkout"),
          "undefined" != typeof ghostSearchApiKey
            ? ((z = ghostHost),
              (B = ghostSearchApiKey),
              (E = new GhostContentAPI({ url: z, key: B, version: "v2" })),
              (P = []),
              (R = {
                shouldSort: !0,
                ignoreLocation: !0,
              ...
              E.posts
                ...
                .then(function (e) {
                  for (var t = 0, n = e.length; t < n; t++) P.push(e[t]);
                  S = new m.a(P, R);
                })
                .catch(function (e) {
                  console.log(e);
                }))
            : (v.css("visibility", "visiable"), w.remove(), k.remove());
      });
    },
  },
  [[13, 0, 1]],
